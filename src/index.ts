...
import { GlobioConfig, GlobioSession, GlobioUser, GlobioResult, GlobioError, DocumentQueryOptions, GlobioRoomEvent, GlobioDocument, DocCollection, DocIndex, AccessLevel, VaultFolder, VaultFile, MultipartUploadInit, DownloadUrl, VaultListFilesResult } from './types';
...
export type { GlobioConfig, GlobioSession, GlobioUser, GlobioResult, GlobioError, DocumentQueryOptions, GlobioRoomEvent, GlobioDocument, DocCollection, DocIndex, AccessLevel, VaultFolder, VaultFile, MultipartUploadInit, DownloadUrl, VaultListFilesResult, DocOptions };
