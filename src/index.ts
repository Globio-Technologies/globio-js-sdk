...
import { GlobioConfig, GlobioSession, GlobioUser, GlobioResult, GlobioError, DocumentQueryOptions, GlobioRoomEvent } from './types';
...
export type { GlobioConfig, GlobioSession, GlobioUser, GlobioResult, GlobioError, DocumentQueryOptions, GlobioRoomEvent, DocOptions };
