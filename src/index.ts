...
import { GlobioConfig, GlobioSession, GlobioUser, GlobioResult, GlobioError, DocumentQueryOptions, GlobioRoomEvent, GlobioDocument, DocCollection, DocIndex } from './types';
...
export type { GlobioConfig, GlobioSession, GlobioUser, GlobioResult, GlobioError, DocumentQueryOptions, GlobioRoomEvent, GlobioDocument, DocCollection, DocIndex, DocOptions };
